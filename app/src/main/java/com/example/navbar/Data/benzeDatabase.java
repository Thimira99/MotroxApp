...
public class benzeDatabase extends SQLiteOpenHelper {
    private Context context;
    private static final String DATABASE_NAME = "benzedatabase.db";
    private static final int DATABASE_VERSION = 1;

    private static final String TABLE_NAME = "BENZE_Table";
    ...
    public benzeDatabase(@Nullable Context context) {
