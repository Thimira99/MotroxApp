...
public class ItemCustomAdapter extends RecyclerView.Adapter<ItemCustomAdapter.MyViewHolder>  {
    ...
    ItemCustomAdapter(Activity activity, Context context, ArrayList id, ArrayList nic, ArrayList firstName, ArrayList lastName, ArrayList streetAddress,
    ...
    @Override
    public void onBindViewHolder(@NonNull @org.jetbrains.annotations.NotNull ItemCustomAdapter.MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
